...
const Model: React.FC<ModelProps> = ({ open, onClose, title, fields, onSubmit, isEdit, config, initialValues }) => {
      ...
      >
        ...
        <div className="space-y-4 max-h-[450px] overflow-y-auto pr-2"
         style={{ maxHeight: config?.bodyHeight || "450px" }}>
          ...
          {fields.map((f) => (
            <div key={f.key}>
              <label className="block mb-1 font-extrabold ">{f.label}</label>
              ...
              {f.type === "textarea" ? (
                ...
                <textarea
                  ...
                  readOnly={f.readonly}
                  className="border hover:border-primary rounded-lg p-2 w-full  bg-gray-100 dark:bg-gray-300"
                  style={{
