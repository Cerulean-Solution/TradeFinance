    ...
    <div className="p-6 space-y-6">
      ...
      {loading ? (
        ...
        <div className="card p-6 space-y-6">
          ...
          <div className="border rounded-md p-4 h-96 font-serif whitespace-pre-wrap overflow-y-auto border-gray-300  focus:ring-2 focus:ring-primary-light">
    ...
    return (
      <div className="flex flex-col gap-2">
        ...
        <textarea
          ...
          className="input min-h-96 font-sans whitespace-pre-wrap focus:ring-2 focus:ring-primary-light font-bold"
          value={value}
          onChange={onChange}
          placeholder={placeholder}
          disabled={disabled}
